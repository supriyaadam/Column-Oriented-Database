...
public class ColumnarFile {
    ...
    public Heapfile[] getHeapFileColumns() {
        return heapFileColumns;
    }
	...
	public AttrType getAttributeTypebyColumnNumber(int Columnnumber)
	{
		return attributeType[Columnnumber];
	}

	
	public short[] getStrSizes(){return strSizes;}
